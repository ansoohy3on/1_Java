...
public class OpExample { // 예제 코드 작성용 클래스
	...
	public void ex1() {
		...
		System.out.println("println 자동완성 해 봤어요~");
	...
	public void ex2() {
		...
		int input1 = sc.nextInt(); // 다음 입력되는 정수를 읽어 옴
...
//		System.out.println( 1 <= b <= 10); // java에서는 불가능한 수식임
		...
		// ||(OR) 연산자 : 둘 다 false이면 false, 나머지는 true (AND의 반대)
		// 또는, ~거나, ~이거나
